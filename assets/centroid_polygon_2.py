...
def process_rooms(input_file_path, output_file_path):
    ...
    with open(input_file_path, 'r') as file:
        for line in file:
            ...
            room_centroids[room_id] = {"x": int(round(float(centroid.x)*0.285)) + 285, "y": int(round(float(centroid.y)*0.285)) + 200}
...
input_file_path = 'room_points_floor2_output.txt'
output_file_path = 'centroids_floor2.json'
